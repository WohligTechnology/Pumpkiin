myApp.controller("ProductRegistrationCtrl", function (
  ...
  $scope.template = TemplateService.getHTML(
    "content/productRegistration/productRegistration.html"
  );
  ...
  $scope.goToNxtTab = function (data) {
    ...
    $scope.warrantyExpDate = data.warrantyExpDate;
    $scope.insuranceExpDate = data.insuranceExpDate;
