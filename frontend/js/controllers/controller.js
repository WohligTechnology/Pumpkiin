  ...
  .controller("HomeCtrl", function(
    ...
    $scope.toggleClass = function(val) {
      if (val == 1) {
        ...
        $scope.showClass2 = !$scope.showClass2;
      }
    };
    ...
    $scope.addUser = function(data) {
      ...
      NavigationService.apiCallWithData("ContactUs/sendEmail", data, function(
        result
      ) {
    ...
    $scope.testimonials = [
      ...
      },
      {
        name: "Priti",
        message:
          "No more going through IVRs, or coordinating with service personnel. Pumpkiin does it all! Wonderful!",
        rate: "5"
      },
      {
        name: "Parth",
      ...
      },
      {
        name: "Priyanka",
        message:
          "Just one message, and Pumpkiin took care of the rest. So useful!",
        rate: "5"
      }
    ];
  })
