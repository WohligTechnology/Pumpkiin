...
myApp
  ...
  .controller("TicketcreationCtrl", function(
    ...
    $scope.statusArr = [
      "Repair/ Maintenance (On-site)",
      "Scheduling service with customer (Open)",
      "Coordinating with the service provider (Open)",
      "Service confirmed (In-progress)",
      "Service completed (Closed)",
      "Appliance picked up (In-progress)",
      "Appliance returned (Closed)",
