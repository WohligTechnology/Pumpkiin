...
myApp.controller('DashboardCtrl', function ($scope, TemplateService, NavigationService, $timeout, $state) {
    ...
    .controller('ClosedTicketcreationCtrl', function ($scope, TemplateService, reminderService, NavigationService, $timeout, toastr, $http, $uibModal, ticketService, $stateParams) {
    ...
    .controller('ProductlistCtrl', function ($scope, TemplateService, NavigationService, $timeout, $stateParams, $state, toastr) {
        //Used to name the .html file
    ...
    .controller('TicketlistCtrl', function ($scope, TemplateService, NavigationService, $timeout, $stateParams, $state, toastr) {
        //Used to name the .html file
